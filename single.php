...
<div id="content" class="site-content">  	
    ...
    <div id="primary" class="content-area <?php primal_layout_class(); ?>  columns">
		...
		<?php while ( have_posts() ) : the_post(); ?>
			...
			<?php do_action('primal_after_single_content'); ?>
			<?php if( get_theme_mod ('social_sharing_box')): ?>
				<div class="share-box">
					<h4><?php _e( 'Share this on ...', 'primal' ); ?></h4>
					<ul>
				...
				<section class="author-bio clearfix">
					<div class="author-info">
						...
						<div class="description">
							<h4><?php echo __( 'About Author:', 'primal' ); ?> <?php the_author_posts_link(); ?></h4>
			...
			<?php if( get_theme_mod('related_posts') && function_exists( 'primal_related_posts' ) ) : ?>
				<section class="related-posts clearfix">
					<?php primal_related_posts(); ?>
				</section>
			<?php endif;  ?>
